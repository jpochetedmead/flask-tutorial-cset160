...
# The update function takes an argument, id. That corresponds to the <int:id> in the route.
...
# To generate a URL to the update page, url_for() needs to be passed the id so it knows what to fill in: url_for('blog.update', id=post['id']). T
